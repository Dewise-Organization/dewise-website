      ...
      <div className="container-max px-6">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              {activeDropdown === 'about' && (
                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-sand py-2 z-50">
                  ...
                  <Link href="/partners" className="block px-4 py-2 text-charcoal hover:bg-sand transition-colors">
                    Partners
                  </Link>
                </div>
              )}
            ...
            <Link href="/programs" className="text-charcoal hover:text-sky font-medium transition-colors">
              Programs
            </Link>
            
            <Link href="/projects" className="text-charcoal hover:text-sky font-medium transition-colors">
              Projects
            </Link>
            
            <Link href="/partnerships" className="text-charcoal hover:text-sky font-medium transition-colors">
              Partnerships
            </Link>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="pl-4 space-y-2">
                  ...
                  <Link href="/partners" className="block py-2 text-charcoal hover:text-sky">
                    Partners
                  </Link>
                </div>
              </div>
              
              <Link href="/programs" className="block py-2 text-charcoal hover:text-sky font-medium">
                Programs
              </Link>
              
              <Link href="/projects" className="block py-2 text-charcoal hover:text-sky font-medium">
                Projects
              </Link>
              
              <Link href="/partnerships" className="block py-2 text-charcoal hover:text-sky font-medium">
                Partnerships
              </Link>
